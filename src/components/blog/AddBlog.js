        ...
        <div className="Add__Blog">
            ...
            <div className="page__row">
                <div className="form__group">
                    ...
                    <input type="text" id="title" name="title" className="form__control" onChange={handleChange} placeholder="Blog title" value={formData.title} />
                </div>
                <div className="form__group">
                    <label htmlFor="description" className="form__label">Description</label>
                    <input type="text" id="description" name="description" className="form__control" placeholder="Brief description about this blog (about 15~20 words)" onChange={handleChange} value={formData.description} />
                </div>
                <div className="form__group">
                    <label htmlFor="timeToRead" className="form__label">Time to Read</label>
                    <input type="number" id="timeToRead" name="timeToRead" className="form__control" onChange={handleChange} placeholder="Example: 10" value={formData.timeToRead} />
                </div>
                <div className="form__group">
                    <label htmlFor="content" className="form__label">Content</label>
                    <textarea id="content" name="content" rows="10" className="form__control" onChange={handleChange} placeholder="Paste here the blog content" value={formData.content}>
                    </textarea>
                </div>
                <div className="form__group">
                    <label htmlFor="imageURL" className="form__label">Image URL</label>
                    <input type="url" id="imageURL" name="imageURL" className="form__control" onChange={handleChange} placeholder="Blog poster image" value={formData.imageURL} />
                </div>
